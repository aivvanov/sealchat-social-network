...
const ProfileInfo = (props) => {
    return (
        <div>
            <div>
                <img className={styles.background_image} src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMAe0I2cx5QFKTEMFDAm9Y4g2twU40K2OM5RMYFpnOzV0BV54qM7a8zvvBsxxHzSfetnk&usqp=CAU'>
                </img>
                <div className={styles.user_name}>
                    <img className={styles.profile_picture} src='https://i0.wp.com/tanhananews.com/wp-content/uploads/2021/07/Ratu-Felisha-Hak-Cipta-Instagramallaboutfelishagtr.jpg?fit=800%2C677&ssl=1'></img>
                    Ratu Felisha
                </div>
